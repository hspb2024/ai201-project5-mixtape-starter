...
def get_friends_listening_now(user_id: str) -> list[dict]:
    ...
    # "Listening now" means today, not "within the last 24 hours". A rolling 24h
    # window keeps last night's listens visible into the next morning; the cutoff
    # must be the start of the current calendar day (UTC).
